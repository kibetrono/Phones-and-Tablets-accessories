...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $arrPermissions = [
            // delivery man
            [
                'name' => 'manage deliverman payment',
                'guard_name' => 'web',
                'created_at' => date('Y - m - d H:i:s'),
                'updated_at' => date('Y - m - d H:i:s'),
            ],
            [
                'name' => 'manage deliverman transaction',
                'guard_name' => 'web',
                'created_at' => date('Y - m - d H:i:s'),
                'updated_at' => date('Y - m - d H:i:s'),
            ],
            [
                'name' => 'manage deliverman invoice',
                'guard_name' => 'web',
                'created_at' => date('Y - m - d H:i:s'),
                'updated_at' => date('Y - m - d H:i:s'),
            ],
            [
                'name' => 'manage deliverman proposal',
                'guard_name' => 'web',
                'created_at' => date('Y - m - d H:i:s'),
                'updated_at' => date('Y - m - d H:i:s'),
            ],
            [
                'name' => 'show deliveryman',
                'guard_name' => 'web',
                'created_at' => date('Y - m - d H:i:s'),
                'updated_at' => date('Y - m - d H:i:s'),
            ],
        ...
        $deliverymanRole->givePermissionTo($deliverymanPermission);
