   ...
   protected $appends = ['profile'];
    ...
    public function assignPlan($planID)
    {
        ...
        if($plan)
        {
            ...
            $delivers   = DeliveryMan::where('created_by', '=', $this->id)->get();
            ...
            else
            {
                ...
                foreach($delivers as $del)
                {
                    ...
                    if($deliverymanCount <= $plan->max_deliverymen)
                    {
                        $del->is_active = 1;
    ...
    public function deliverymanNumberFormat($number)
    {
        $settings = Utility::settings();

        return $settings["deliveryman_prefix"] . sprintf("%05d", $number);
    }
    ...
    public function countDeliveryPersons()
    {
    ...
    public function totalCompanyDeliveryman($id)
    {
        return DeliveryMan::where('created_by', '=', $id)->count();
    }
