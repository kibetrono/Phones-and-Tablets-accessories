                    ...
                    <form method="post" action="{{route('update.password')}}">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-sm-6 form-group">
                                <label for="current_password" class="col-form-label text-dark">{{ __('Old Password') }}</label>
                            ...
                            <div class="col-lg-6 col-sm-6 form-group">
                                <label for="new_password" class="col-form-label text-dark">{{ __('Password') }}</label>
                            ...
                            <div class="col-lg-6 col-sm-6 form-group">
                                <label for="confirm_password" class="col-form-label text-dark">{{ __('Confirm Password') }}</label>
                                <input class="form-control @error('confirm_password') is-invalid @enderror" name="confirm_password" type="password" required autocomplete="new-password" id="confirm_password" placeholder="{{ __('Enter Your Password') }}">
                            </div>
                            <div class="col-lg-12 text-end">
