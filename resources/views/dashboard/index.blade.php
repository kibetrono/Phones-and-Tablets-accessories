                                ...
                                <div class="col-md-3 col-6 my-2">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="ms-2">
                                            ...
                                            <h4 class="mb-0 text-danger">{{\Auth::user()->priceFormat(\Auth::user()->todayExpense())}}</h4>
                                ...
                                <div class="col-md-3 col-6 my-2">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="ms-2">
                                            ...
                                            <h4 class="mb-0 text-success">{{\Auth::user()->priceFormat(\Auth::user()->incomeCurrentMonth())}}</h4>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-pills mb-5" id="pills-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="pills-Dashboard-tab" data-bs-toggle="pill" href="#invoice_weekly_statistics" role="tab" aria-controls="pills-home" aria-selected="true">{{__('Invoices Weekly Statistics')}}</a>
                                </li>
                                <li class="nav-item">
                                                ...
                                                <span>
                                                    <span class="row align-items-center mt-3">
                                                        ...
                                                        <span class="col">
                                                            ...
                                                            <h6 class="mb-3 mb-sm-0">{{number_format($goal->target($goal->type,$goal->from,$goal->to,$goal->amount)['percentage'], Utility::getValByName('decimal_number'), '.', '')}}%</h6>
                                                            <div class="progress mb-0">
                                                                <div class="progress-bar bg-primary"  style="width: {{number_format($goal->target($goal->type,$goal->from,$goal->to,$goal->amount)['percentage'], Utility::getValByName('decimal_number'), '.', '')}}%"></div>
                                                            </div>
                                                        </span>
                                                    </span>
                                                </span>
