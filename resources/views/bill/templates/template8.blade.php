            ...
            <div class="invoice-preview-inner">
                <div class="editor-content">
                    <div class="preview-main client-preview">
                        <div data-v-136bf9b5="" class="d" style="width: 770px; margin-left: 30px; margin-right: 0;" id="boxes">
                            <div data-v-136bf9b5="" class="d-inner">
                                <div data-v-136bf9b5="" class="row">
                                    ...
                                    <div data-v-136bf9b5="" class="col-33"><h1 data-v-136bf9b5="" class="fancy-title mb5" style="color: {{$color}};">{{__('Bill')}}</h1></div>
                                ...
                                <div data-v-136bf9b5="" class="row">
                                    <div data-v-136bf9b5="" class="col-33">
                                        <table data-v-136bf9b5="" class="summary-table">
                                            ...
                                            <tr data-v-136bf9b5="">
                                                ...
                                                <td data-v-136bf9b5="" class="text-end">{{\App\Models\Utility::billNumberFormat($settings,$bill->bill_id)}}</td>
                                            </tr>
                                            <tr data-v-136bf9b5="">
                                                <td data-v-136bf9b5="" class="fwb">{{__('Issue Date')}}:</td>
                                                <td data-v-136bf9b5="" class="text-end">{{\App\Models\Utility::dateFormat($settings,$bill->bill_date)}}</td>
                                            </tr>
                                            <tr data-v-136bf9b5="">
                                                <td data-v-136bf9b5="" class="fwb">{{__('Due Date')}}:</td>
                                                <td data-v-136bf9b5="" class="text-end">{{\App\Models\Utility::dateFormat($settings,$bill->due_date)}}</td>
                                            </tr>
                                    ...
                                    <div class="col-66" style="position:relative;">
                                ...
                                <div data-v-136bf9b5="" class="break-15"></div>
