            ...
            <div class="invoice-preview-inner">
                <div class="editor-content">
                    <div class="preview-main client-preview">
                        <div data-v-7d9d14b5="" class="d" style="width: 770px; margin-left: 30px; margin-right: 0;" id="boxes">
                            <div data-v-7d9d14b5="" class="d-inner" style="border-right: 50px solid {{$color}};">
                                <div data-v-7d9d14b5="" class="row">
                                    <div data-v-7d9d14b5="" class="col-2"><h1 data-v-7d9d14b5="" class="fancy-title tu mb5" style="color: {{$color}};">{{__('BILL')}}</h1>
                                        ...
                                        <p data-v-7d9d14b5="">{{\App\Models\Utility::dateFormat($settings,$bill->bill_date)}}</p>
                                    </div>
                                ...
                                <div data-v-7d9d14b5="" class="row">
                                    ...
                                    <div data-v-7d9d14b5="" class="col-33" style="position: relative;">
