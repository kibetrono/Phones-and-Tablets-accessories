            ...
            <div class="invoice-preview-inner">
                <div class="editor-content">
                    <div class="preview-main client-preview">
                        <div data-v-e23d9750="" class="d" style="width: 770px; margin-left: 30px; margin-right: 0;" id="boxes">
                            <div data-v-e23d9750="" class="d-inner">
                                <div data-v-e23d9750="" class="row">
                                    <div data-v-e23d9750="" class="col-66"><h1 data-v-e23d9750="" class="fancy-title tu mb5" style="background: {{$color}};color:{{$font_color}}">{{__('BILL')}}</h1></div>
                                    ...
                                    <div data-v-e23d9750="" class="col-33">
                                        <table data-v-e23d9750="" class="summary-table">
                                            ...
                                            <tr data-v-e23d9750="">
                                                ...
                                                <td data-v-e23d9750="" class="text-end">{{\App\Models\Utility::billNumberFormat($settings,$bill->bill_id)}}</td>
                                            </tr>
                                            <tr data-v-e23d9750="">
                                                <td data-v-e23d9750="" class="tu fwb">{{__('Issue Date')}}:</td>
                                                <td data-v-e23d9750="" class="text-end">{{\App\Models\Utility::dateFormat($settings,$bill->bill_date)}}</td>
                                            </tr>
                                            <tr data-v-e23d9750="">
                                                <td data-v-e23d9750="" class="tu fwb">{{__('Due Date')}}:</td>
                                                <td data-v-e23d9750="" class="text-end">{{\App\Models\Utility::dateFormat($settings,$bill->due_date)}}</td>
                                            </tr>
                                            <tr class="ml-8" >
                                                <td class="">
