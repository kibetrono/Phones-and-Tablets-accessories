            ...
            <div class="invoice-preview-inner">
                <div class="editor-content">
                    <div class="preview-main client-preview">
                        <div data-v-37eeda86="" class="d" style="width: 770px; margin-left: 30px; margin-right: 0;" id="boxes">
                                ...
                                <div data-v-37eeda86="" class="col-33">
                                    ...
                                    <table data-v-37eeda86="" class="summary-table">
                                        ...
                                        <tr data-v-37eeda86="">
                                            ...
                                            <td data-v-37eeda86=""
                                                class="text-end">{{\App\Models\Utility::dateFormat($settings,$bill->bill_date)}}</td>
                                        </tr>
                                        <tr data-v-37eeda86="">
