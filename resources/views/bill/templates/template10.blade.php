            ...
            <div class="invoice-preview-inner">
                <div class="editor-content">
                    <div class="preview-main client-preview">
                        <div data-v-b8f60a0c="" class="d" style="width: 770px; margin-left: 30px; margin-right: 0;" id="boxes">
                            <div data-v-b8f60a0c="" class="d-inner">
                                ...
                                <div data-v-b8f60a0c="" class="row">
                                    ...
                                    <div data-v-b8f60a0c="" class="col-33" style="position:relative;">
                                        <table data-v-b8f60a0c="" class="summary-table">
                                            ...
                                            <tr data-v-b8f60a0c="">
                                                ...
                                                <td data-v-b8f60a0c="" class="text-end">{{\App\Models\Utility::billNumberFormat($settings,$bill->bill_id)}}</td>
                                            </tr>
                                            <tr data-v-b8f60a0c="">
                                                <td data-v-b8f60a0c="" class="tu fwb" style="color: {{$color}};">{{__('Issue Date')}}:</td>
                                                <td data-v-b8f60a0c="" class="text-end">{{\App\Models\Utility::dateFormat($settings,$bill->bill_date)}}</td>
                                            </tr>
                                            <tr data-v-b8f60a0c="">
                                                <td data-v-b8f60a0c="" class="tu fwb" style="color: {{$color}};">{{__('Due Date')}}:</td>
                                                <td data-v-b8f60a0c="" class="text-end">{{\App\Models\Utility::dateFormat($settings,$bill->due_date)}}</td>
                                            </tr>
                                ...
                                <div data-v-b8f60a0c="" class="break-25" style ="height: 80px;"></div>
                                <div class="row">
                                    <div class="bill_to">
