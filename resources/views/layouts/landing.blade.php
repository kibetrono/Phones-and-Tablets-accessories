...
<body class="{{$color}}" dir="{{env('SITE_RTL') == 'on'?'rtl':''}}">
<!-- [ Nav ] start -->
        ...
        <div class="row align-items-center justify-content-between">
            <div class="col-sm-5">
                ...
                <h2
                    ...
                    data-wow-delay="0.4s"
                >
                   {{__('Accounting and Billing Tool')}}
                </h2>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-6 text-end">
                <p class="text-body">{{(Utility::getValByName('footer_text')) ? Utility::getValByName('footer_text') :  __('Copyright AccountGo SaaS') }} {{ date('Y') }}</p>
            </div>
        </div>
    </div>
</section>
