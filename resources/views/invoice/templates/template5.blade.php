                                    ...
                                    <div data-v-e23d9750="" class="col-33">
                                        <table data-v-e23d9750="" class="summary-table">
                                            ...
                                            <tr data-v-e23d9750="">
                                                ...
                                                <td data-v-e23d9750="" class="text-end">{{\App\Models\Utility::invoiceNumberFormat($settings,$invoice->invoice_id)}}</td>
                                            </tr>
                                            <tr data-v-e23d9750="">
                                                <td data-v-e23d9750="" class="tu fwb">{{__('Issue Date')}}:</td>
                                                <td data-v-e23d9750="" class="text-end">{{\App\Models\Utility::dateFormat($settings,$invoice->issue_date)}}</td>
                                            </tr>
                                            <tr data-v-e23d9750="">
                                                <td data-v-e23d9750="" class="tu fwb">{{__('Due Date')}}:</td>
                                                <td data-v-e23d9750="" class="text-end">{{\App\Models\Utility::dateFormat($settings,$invoice->due_date)}}</td>
                                            </tr>
                                            <tr class="ml-8" >
                                                <td class="">
                                           ...
                                           @if(!empty($customFields) && count($invoice->customField)>0)
                                                @foreach($customFields as $field)
                                                    <tr>
                                                        <td data-v-e23d9750="" class="tu fwb">{{$field->name}} :</td>
                                                        <td data-v-e23d9750="" class="text-end"> {{!empty($invoice->customField)?$invoice->customField[$field->id]:'-'}}</td>
                                                    </tr>
                                                @endforeach
                                            @endif
                                            </tbody>
