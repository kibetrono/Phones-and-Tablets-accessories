                        ...
                        <div data-v-363339a0="" class="d" style="width: 770px; margin-left: 30px; margin-right: 0;" id="boxes">
                            <div data-v-363339a0="" class="d-inner">
                                ...
                                <div class="row">
                                    ...
                                    <div data-v-363339a0="" class="col-1 text-end" style="position: relative">
                                        <div data-v-363339a0="" class="">
                                            <table data-v-363339a0="" class="summary-table">
                                                ...
                                                <tr data-v-363339a0="">
                                                    ...
                                                    <td data-v-363339a0="" class="text-end">{{\App\Models\Utility::invoiceNumberFormat($settings,$invoice->invoice_id)}}</td>
                                                </tr>
                                                <tr data-v-363339a0="">
                                                    <td data-v-363339a0="" class="tu fwb" style="color: {{$color}};">{{__('Issue Date')}}:</td>
                                                    <td data-v-363339a0="" class="text-end">{{\App\Models\Utility::dateFormat($settings,$invoice->issue_date)}}</td>
                                                </tr>
                                                <tr data-v-363339a0="">
                                                    <td data-v-363339a0="" class="tu fwb" style="color: {{$color}};">{{__('Due Date')}}:</td>
                                                    <td data-v-363339a0="" class="text-end">{{\App\Models\Utility::dateFormat($settings,$invoice->due_date)}}</td>
                                                </tr>
                                               ...
                                               @if(!empty($customFields) && count($invoice->customField)>0)
                                                    @foreach($customFields as $field)
                                                        <tr>
                                                            ...
                                                            <td data-v-363339a0=""> {{!empty($invoice->customField)?$invoice->customField[$field->id]:'-'}}</td>
                                                        </tr>
                                                    @endforeach
                                                @endif
                                        ...
                                        <div data-v-f2a183a6="" class="d-table-footer">
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-summary">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-value">{{\App\Models\Utility::priceFormat($settings,($invoice->getTotal()-$invoice->getDue())-($invoice->invoiceTotalCreditNote()))}}</div>
                                                </div>
                                                <div data-v-f2a183a6="" class="d-table-summary-item">
                                                    <div data-v-f2a183a6="" class="d-table-label">{{__('Credit Note')}}:</div>
                                                    <div data-v-f2a183a6="" class="d-table-value">{{\App\Models\Utility::priceFormat($settings,($invoice->invoiceTotalCreditNote()))}}</div>
                                                </div>
                                                <div data-v-f2a183a6="" class="d-table-summary-item">
