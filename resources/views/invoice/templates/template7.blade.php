                        ...
                        <div data-v-1ad6e3b9="" class="d" style="width: 770px; margin-left: 30px; margin-right: 0;" id="boxes">
                            <div data-v-1ad6e3b9="" class="d-inner d-no-pad" style="border-top: 15px solid {{$color}}; border-bottom: 15px solid {{$color}};">
                                <div data-v-1ad6e3b9="" class="row grey-box">
                                    ...
                                    <div data-v-1ad6e3b9="" class="col-33" style="position: relative;"><h1 data-v-1ad6e3b9="" class="fancy-title mb5">{{__('INVOICE')}}</h1> <br data-v-1ad6e3b9=""><br data-v-1ad6e3b9="">
                                        <table data-v-1ad6e3b9="" class="summary-table">
                                            ...
                                            <tr class="ml-8" style="position: relative;">
                                           ...
                                           @if(!empty($customFields) && count($invoice->customField)>0)
                                                @foreach($customFields as $field)
                                                    <tr data-v-1ad6e3b9="">
                                                        ...
                                                        <td data-v-1ad6e3b9="" class="text-end"> {{!empty($invoice->customField)?$invoice->customField[$field->id]:'-'}}</td>
                                                    </tr>
                                                @endforeach
                                            @endif
                                            </tbody>
