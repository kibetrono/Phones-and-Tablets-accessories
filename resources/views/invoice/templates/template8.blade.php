                                    ...
                                    <div data-v-136bf9b5="" class="col-33">
                                        <table data-v-136bf9b5="" class="summary-table">
                                            ...
                                            <tr data-v-136bf9b5="">
                                                ...
                                                <td data-v-136bf9b5="" class="text-end">{{\App\Models\Utility::invoiceNumberFormat($settings,$invoice->invoice_id)}}</td>
                                            </tr>
                                            <tr data-v-136bf9b5="">
                                                <td data-v-136bf9b5="" class="fwb">{{__('Issue Date')}}:</td>
                                                <td data-v-136bf9b5="" class="text-end">{{\App\Models\Utility::dateFormat($settings,$invoice->issue_date)}}</td>
                                            </tr>
                                            <tr data-v-136bf9b5="">
                                                <td data-v-136bf9b5="" class="fwb">{{__('Due Date')}}:</td>
                                                <td data-v-136bf9b5="" class="text-end">{{\App\Models\Utility::dateFormat($settings,$invoice->due_date)}}</td>
                                            </tr>
                                            <tr class="ml-8">
                                                <td class="">
                                           ...
                                           @if(!empty($customFields) && count($invoice->customField)>0)
                                                @foreach($customFields as $field)
                                                    <tr data-v-136bf9b5="">
                                                        ...
                                                        <td data-v-136bf9b5="" class="text-end"> {{!empty($invoice->customField)?$invoice->customField[$field->id]:'-'}}</td>
                                                    </tr>
                                                @endforeach
                                            @endif
                                            </tbody>
