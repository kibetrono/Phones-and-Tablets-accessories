                        ...
                        @endif
                            <div class="d-flex align-items-center justify-content-end">
                                ...
                                <div class="col-auto float-end ms-2 mt-4">
                                    ...
                                    @if (!\Auth::guard('customer')->check())
                                        <a href="{{ route('invoice.index') }}" class="btn btn-sm btn-primary" data-toggle="tooltip"
                                           data-original-title="{{ __('Reset') }}">
                                            <span class="btn-inner--icon"><i class="ti ti-trash text-white-off"></i></span>
                                        </a>
                                    @else
                                        <a href="{{ route('customer.index') }}" class="btn btn-sm btn-danger" data-toggle="tooltip"
                                           data-original-title="{{ __('Reset') }}">
