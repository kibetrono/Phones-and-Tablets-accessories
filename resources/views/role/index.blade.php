                                ...
                                <tr class="font-style">
                                    ...
                                    <td class="Permission">
                                        @for($j=0;$j<count($role->permissions()->pluck('name'));$j++)
                                            <a href="#" class="badge rounded-pill bg-primary">{{$role->permissions()->pluck('name')[$j]}}</a>
                                        @endfor
                                    </td>
                                    <td class="Action">
                                        <span>
                                        @can('edit role')
                                            <div class="action-btn bg-info ms-2">
                                                <a href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-url="{{ route('roles.edit',$role->id) }}" data-size="xl" data-ajax-popup="true" data-bs-toggle="tooltip" data-original-title="{{__('Edit')}}" title="{{__('Edit')}}">
