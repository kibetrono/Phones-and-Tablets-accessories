            ...
            <div class="form-group">
                @if(!empty($permissions))
                    ...
                    <table class="table  mb-0" id="dataTable-1">
                        ...
                        <tr>
                            <th>
                                <input type="checkbox" class="align-middle" name="checkall"  id="checkall" >
                            </th>
                            <th>{{__('Module')}} </th>
                        ...
                        <tbody>
                        @php
                            $modules=['dashboard','user','role','proposal','invoice','bill','revenue','payment','proposal product','invoice product','bill product','goal','bank account','transfer','transaction','product & service','customer','vender','plan','constant tax','constant category','constant unit','constant custom field','company settings','assets','chart of account','journal entry','report'];
