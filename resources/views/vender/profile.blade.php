        ...
        <div class="col-xl-3">
            <div class="card sticky-top" style="top:30px">
                <div class="list-group list-group-flush" id="useradd-sidenav">
                    ...
                    <a href="#billing_info" class="list-group-item list-group-item-action">{{__('Billing Info')}}<div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                    <a href="#shipping_info" class="list-group-item list-group-item-action">{{__('Shipping Info')}}<div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
