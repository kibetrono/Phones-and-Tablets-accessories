                    ...
                    <div class="row issue_date">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-icon-user">
                                    {{ Form::text('until_date', isset($data['until_date'])?$data['until_date']:null, array('class' => 'form-control pc-datepicker-1')) }}
                                        ...
                                        <table class="table align-items-center table_header">
                                            ...
                                            @forelse($bill_payment as $payment)
                                                <tr>
                                                    ...
                                                    <td>{{\Auth::user()->invoiceNumberFormat($payment->invoice_id)}}</td>
                                            ...
                                            <tr class="total">
                                                ...
                                                <td class="light_blue"><strong>{{\Auth::user()->priceFormat($total)}}</strong></td>
                                            </tr>
