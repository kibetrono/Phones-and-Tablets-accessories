        ...
        <div class="row mt-3">
            <div class="col">
                ...
                <div class="card p-4 mb-4">
                    ...
                    <h6 class="report-text mb-0">{{__('Ledger Summary')}}</h6>
                </div>
            </div>
            ...
            <div class="row mt-3">
                <div class="col">
                    <div class="card p-4 mb-4">
                        ...
                        <h6 class="report-text mb-0">{{$account->name}}</h6>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="card p-4 mb-4">
                        ...
                        <h6 class="report-text mb-0">{{$account->code}}</h6>
                    </div>
                </div>
                <div class="col">
                    <div class="card p-4 mb-4">
                        <h7 class="report-text gray-text mb-0">{{__('Total Debit')}} :</h7>
                        <h6 class="report-text mb-0">{{\Auth::user()->priceFormat($filter['debit'])}}</h6>
                    </div>
                </div>
                <div class="col">
                    <div class="card p-4 mb-4">
                        <h7 class="report-text gray-text mb-0">{{__('Total Credit')}} :</h7>
                        <h6 class="report-text mb-0">{{\Auth::user()->priceFormat($filter['credit'])}}</h6>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="card p-4 mb-4">
                        ...
                        <h6 class="report-text mb-0">{{($filter['balance']>0)?__('Cr').'. '.\Auth::user()->priceFormat(abs($filter['balance'])):__('Dr').'. '.\Auth::user()->priceFormat(abs($filter['balance']))}}</h6>
                    </div>
                </div>
            </div>
        @endif
