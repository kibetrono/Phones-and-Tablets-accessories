                        ...
                        <div data-v-b8f60a0c="" class="d" style="width: 770px; margin-left: 30px; margin-right: 0;" id="boxes">
                            <div data-v-b8f60a0c="" class="d-inner">
                                <div data-v-b8f60a0c="" class="row">
                                    <div data-v-b8f60a0c="" class="col-33"><h1 data-v-b8f60a0c="" class="fancy-title tu mb5" style="color: {{$color}}; border-top: 15px solid {{$color}};">{{__('PROPOSAL')}}</h1></div>
                                    ...
                                    <div data-v-b8f60a0c="" class="col-33" style="position:relative;">
                                        <table data-v-b8f60a0c="" class="summary-table">
                                            ...
                                            <tr data-v-363339a0="">
                                                ...
                                                <td data-v-363339a0="" class="text-end">{{\App\Models\Utility::proposalNumberFormat($settings,$proposal->proposal_id)}}</td>
                                            </tr>
                                            <tr data-v-363339a0="">
                                            ...
                                            <tr class="float-right mt-5" style="position: relative; right: 0;">
                                                <td class="" style="position:absolute; right: 0;">
                                            ...
                                            @if(!empty($customFields) && count($proposal->customField)>0)
                                                @foreach($customFields as $field)
                                                    <tr data-v-363339a0="">
                                                        ...
                                                        <td data-v-363339a0="" class="text-end"> {{!empty($proposal->customField)?$proposal->customField[$field->id]:'-'}}</td>
                                                    </tr>
                                                @endforeach
                                            @endif
                                            </tbody>
                                ...
                                <div data-v-b8f60a0c="" class="d-table">
                                    <div data-v-b8f60a0c="" class="d-table">
                                        ...
                                        <div class="d-table-tr" style="border-bottom:1px solid {{$color}};">
                                            ...
                                            <div class="d-table-td w-3">
                                                <pre data-v-f2a183a6="">{{\App\Models\Utility::priceFormat($settings,$proposal->totalRate)}}</pre>
                                            </div>
                                            <div class="d-table-td w-6">
                                                <pre data-v-f2a183a6="">{{\App\Models\Utility::priceFormat($settings,$proposal->totalTaxPrice) }}</pre>
                                            </div>
                                            @if($proposal->discount_apply==1)
                                                <div class="d-table-td w-3">
                                                    <pre data-v-f2a183a6="">{{\App\Models\Utility::priceFormat($settings,$proposal->totalDiscount)}}</pre>
                                                </div>
                                            @else
                                                <div class="d-table-td w-3">
                                                    <pre data-v-f2a183a6="">-</pre>
                                            ...
                                            <div class="d-table-td w-4 text-end">
                                                    <span>{{\App\Models\Utility::priceFormat($settings,$proposal->getSubTotal())}}
                                                    </span>
                                            </div>
                                        </div>
                                        <div data-v-f2a183a6="" class="d-table-footer">
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-summary">
                                                @if($proposal->discount_apply==1)
                                                    @if($proposal->getTotalDiscount())
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            ...
                                                            <div data-v-f2a183a6="" class="d-table-value">{{\App\Models\Utility::priceFormat($settings,$proposal->getTotalDiscount())}}</div>
                                                        </div>
                                                    @endif
                                                @endif
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid {{$color}}; border-bottom: 1px solid {{$color}};">
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-value">{{\App\Models\Utility::priceFormat($settings,$proposal->getSubTotal()-$proposal->getTotalDiscount()+$proposal->getTotalTax())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
