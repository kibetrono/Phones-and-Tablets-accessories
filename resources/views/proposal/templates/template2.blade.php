                    ...
                    <div class="preview-main client-preview">
                        <div data-v-37eeda86="" class="d" style="width: 770px; margin-left: 30px; margin-right: 0;" id="boxes">
                            <div data-v-37eeda86="" class="d-inner">
                                ...
                                <div data-v-37eeda86="" class="break-150"></div>
                                <div data-v-37eeda86="" class="col-12" style="position: relative; padding-bottom: 30px;">
...
{{--                                        </tr>  --}}
                                    ...
                                    <div class="float-right mt-5" style="text-align: right; right: 00; position: absolute; top: -150px;">
                                        <p> {!! DNS2D::getBarcodeHTML(route('pay.proposalpay',\Illuminate\Support\Facades\Crypt::encrypt($proposal->id)), "QRCODE",2,2) !!}</p>
                                    </div>
                                </div>
                                <div data-v-37eeda86="" class="col-66" ></div>
